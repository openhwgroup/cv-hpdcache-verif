...
parser.add_argument('--nostdout' , dest='nostdout', type=int, help='1: nostdout 0: stdout')
##
args = parser.parse_args()


run.run_test(args.test_name, args.seed, args.debug, args.batch, args.dump, args.num_txn, args.nostdout)
